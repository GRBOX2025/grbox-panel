...
import (
	...
	"GRBOX Panel/web/controller"
	"GRBOX Panel/web/job"
	"GRBOX Panel/web/locale"
	"GRBOX Panel/web/middleware"
	"GRBOX Panel/web/network"
	"GRBOX Panel/web/service"
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("GRBOX Panel", store))
	...
	// Apply the redirect middleware (`/grbox` to `/panel`)
