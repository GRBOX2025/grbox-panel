...
2. Выполните команду `GRBOX Panel` в терминале, затем выберите `SSL Certificate Management`.
...
1. Выполните команду `GRBOX Panel` в терминале, затем выберите `Cloudflare SSL Certificate`.
...
2. После загрузки архива выполните следующие команды для установки или обновления GRBOX Panel:
...
5. **Удаление GRBOX Panel из Docker:**
...
3. **Просмотр текущих настроек:**
   - Чтобы просмотреть текущие настройки, используйте команду `GRBOX Panel settings` в терминале или опцию `View Current Settings` в `GRBOX Panel`.
...
1. Выполните команду `GRBOX Panel` в терминале, затем выберите `IP Limit Management`.
...
- [API документация](https://www.postman.com/hsanaei/GRBOX Panel/collection/q1l5l0u/GRBOX Panel)
